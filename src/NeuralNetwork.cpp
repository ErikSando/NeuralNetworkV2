...
NeuralNetwork::NeuralNetwork() {
    ...
    kernels.emplace_back(std::move(Kernel(MAT_KRNL_PATH, "Multiply")));
    kernels.emplace_back(std::move(Kernel(MAT_KRNL_PATH, "MultiplyBatched")));
    kernels.emplace_back(std::move(Kernel(MAT_KRNL_PATH, "Add")));
    kernels.emplace_back(std::move(Kernel(MAT_KRNL_PATH, "Scale")));
    kernels.emplace_back(std::move(Kernel(ACTV_KRNL_PATH, "ReLU")));
    kernels.emplace_back(std::move(Kernel(ACTV_KRNL_PATH, "Softmax")));
    kernels.emplace_back(std::move(Kernel(BWP_KRNL_PATH, "BackwardPass")));
